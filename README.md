...
passing the updated environment as well. Initial environment is empty '()' and so variables must be assigned before use, or an 'unbound variable' error is raised. 
